...
public abstract class ListTest {
    ...
    @Test
    public final void testRetreatLeftToNonEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "yellow", "orange",
    ...
    @Test
    public final void testRetreatRightFromEmptyToNonEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "yellow", "orange",
    ...
    @Test
    public final void testRetreatRightFromNonEmptyToNonEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "yellow", "orange",
