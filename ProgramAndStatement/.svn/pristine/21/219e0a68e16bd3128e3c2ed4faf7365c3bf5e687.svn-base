...
public abstract class StatementTest {
    ...
    private static final String FILE_NAME_2 = "data/SampleStatement2.bl";
     ...
     */
    @Test
    public final void testKindWhileFile2() {
        /*
         * Setup
         */
        final int whilePos = 3;
     ...
     */
    @Test
    public final void testAddToBlockInteriorFile2() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void testRemoveFromBlockFrontLeavingNonEmptyFile2() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_2);
     ...
     */
    @Test
    public final void testLengthOfBlockNonEmptyFile2() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_2);
     ...
     */
    @Test
    public final void testAssembleIfFile2() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void testDisassembleIfFile2() {
        /*
         * Setup
         */
        Statement blockTest = this.createFromFileTest(FILE_NAME_2);
     ...
     */
    @Test
    public final void testAssembleIfElseFile2() {
        /*
         * Setup
         */
        final int ifElsePos = 2;
     ...
     */
    @Test
    public final void testDisassembleIfElseFile2() {
        /*
         * Setup
         */
        final int ifElsePos = 2;
     ...
     */
    @Test
    public final void testAssembleWhileFile2() {
        /*
         * Setup
         */
        Statement blockTest = this.createFromFileTest(FILE_NAME_2);
     ...
     */
    @Test
    public final void testDisassembleWhileFile2() {
        /*
         * Setup
         */
        final int whilePos = 6;
        Statement blockTest = this.createFromFileTest(FILE_NAME_2);
        Statement blockRef = this.createFromFileRef(FILE_NAME_2);
        Statement sTest = blockTest.removeFromBlock(whilePos);
        Statement sRef = blockRef.removeFromBlock(whilePos);
     ...
     */
    @Test
    public final void testAssembleCallFile2() {
        /*
         * Setup
         */
        Statement sRef = this.constructorRef().newInstance();
     ...
     */
    @Test
    public final void testDisassembleCallFile2() {
        /*
         * Setup
         */
        Statement blockTest = this.createFromFileTest(FILE_NAME_2);
